...
CREATE TABLE SpotifyClone.faixa(
	faixa_id INT PRIMARY KEY AUTO_INCREMENT,
    titulo VARCHAR(50) NOT NULL,
...
CREATE TABLE SpotifyClone.historico(
    ...
    CONSTRAINT PRIMARY KEY(faixa_id, user_id),
    FOREIGN KEY(faixa_id) REFERENCES SpotifyClone.faixa(faixa_id),
    FOREIGN KEY(user_id) REFERENCES SpotifyClone.pessoa_usuaria(user_id)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.album(titulo, ano_de_lancamento, artista_id)
VALUES
	('Envious', '1990', '1'),
	('Exuberant', '1993', '1'),
...
INSERT INTO SpotifyClone.faixa(titulo, duracao_segundos, artista_id, album_id)
VALUES
	('Soul For Us', '200', '1', '1'),
...
INSERT INTO SpotifyClone.historico(user_id, faixa_id, data_reproducao)
VALUES
	...
	('6','29', '2019-02-07 20:33:48'),
	('6','38', '2017-01-24 00:31:17'),
